...
//	public static String accessTokenTest = "2";
//	@Value("${wx.appid}")
...
//		String accessToken = WxUtil.getAccessToken();
	...
	public void testGetMessgeTypeList() {
		List<MessageType> list = messageTypeService.list(-1);
...
//		System.out.println("密码"+ new BCryptPasswordEncoder().encode("123456"));
		System.out.println("密码"+ new BCryptPasswordEncoder().encode("FntPms,9527"));
	...
	@Test
	public void testWxName() throws UnsupportedEncodingException {
//		String str= new String("?捷.BiBi?".getBytes("ISO-8859-1"), "UTF-8");
		String str= URLEncoder.encode("?捷.BiBi?","utf-8");
		str = URLDecoder.decode(str, "utf-8");
		System.out.println(str);
	}

	@Test
	public void testSendWxMsgToUser() {
		int userId = 2;
...
//		return R.status(WxUtil.sendProcessApprovalMsgToUser(customer.getCustomerName(), userInfo, message.getId(), auditDelayCount));
		sendProcessApprovalMsgToUser(customer.getCustomerName(), userInfo, message.getId(), auditDelayCount);
	}
...
//		String url = "http://www.szwd.online:8009/#/ApprovalInformation?messageId=" + messageId + "&userCode=" + userInfo.getUserId();
		String url = "http://saas.szwd.online:9988";
		...
		//
//		String accessToken = "WxUtil.getAccessToken()";
		String accessToken = "63_gXyp5CHUZqZA12yKX-QqTEcU5r8lTVpAUnNR1Ucy4YHmyCIwTn6T-IdfTgUhxAHL_71AE1kAjOd_UM_aJEYklLMt4vzRKefF-87ESuZ2dreJXuKPqd5hd-GIgfcWUXaAHAAYB";
		String sendMsgUrl = "https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=%s";
		sendMsgUrl = String.format(sendMsgUrl, accessToken);
	...
	@Test
	public void testPageInfoUtis() {
		List<Integer> list = new ArrayList<>();
		for(int i = 1; i < 101; i++) {
			list.add(i);
		}
		PageInfo pageInfo = PageInfoUtils.list2PageInfo(list, 2,5);
		List listResult = pageInfo.getList();
...
//		String firstData = "您好，{userCode}，今天需要您审批的单据汇总信息如下";
//		String userCode = "张三";
//		System.out.println(firstData.replaceAll("\\{userCode\\}", userCode));
		String keyword1 = "待审批单据总数：3/n已延期的单据数：3";
		System.out.println(keyword1);
		String str = "\\{\n\\}";
//		System.out.println(str);
		str = "/n";
//		System.out.println(str);
		keyword1 = keyword1.replaceAll(str,"\n");
		System.out.println(keyword1);
	}
...
//		LocalDateTime end=LocalDateTime.of(2022,12,13,15,10,11);
...
//		LocalDate.parse()
//		LocalDateTime.of(LocalDate.parse(),null);

		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		int dateDiff = WxUtil.differentDaysByMillisecond(sdf.parse("2022-12-12"), sdf.parse("2022-12-13"));
		System.out.println("dateDiff:" + dateDiff);
		dateDiff = WxUtil.differentDaysByMillisecond(sdf.parse("2022-12-12"), sdf.parse("2022-12-12"));
		System.out.println("dateDiff:" + dateDiff);
		dateDiff = WxUtil.differentDaysByMillisecond(sdf.parse("2022-12-12"), sdf.parse("2022-12-11"));
		System.out.println("dateDiff:" + dateDiff);
	}
...
//		stringRedisTemplate.opsForValue().set(key,value,24, TimeUnit.HOURS);
		System.out.println("codeId = " + stringRedisTemplate.opsForValue().get(key));
	}
...
//		String url = "http://www.szwd.online:8009/#/userAuthorizationByUserId?serverIp=8.135.96.87&appid=wx226ffc0b68fa17e9";
//		String path = "d:/photo/";
//		String fileName = "a.png";
//		File file = QrCodeUtil.createLoginQrCode(url, path, fileName);
//		byte[] data = WxUtil.fileToBinArray(file);
//		WxUtil.byteToImage(data, "d:/photo/aCopy.png");
//		String guid = "test20230103";
//		String url = "https://www.baidu.com?guid=" + guid;
		String guid = UUID.randomUUID().toString();
		String guidTail2 = guid.substring(guid.length() - 2);
		String guidTail2EnCode = WxUtil.signEnCode(guidTail2.toUpperCase());
		guid = guidTail2EnCode.toUpperCase() + guid;
...
//		String redirectUrl = "http://ihhyh2.natappfree.cc/wx/loginOuth?guid=" + guid;
...
//		String redirectUrl = "http://www.szwd.online/wx/outhBind?serverIp=47.106.188.61&";
//		String redirectUrl = "http://www.szwd.online/wx/outhPage/1/1";
//		url = String.format(url, "wx226ffc0b68fa17e9", redirectUrl);
		url = String.format(url, WxOfficialAccountController.appid, redirectUrl);
//		url = "http://www.szwd.online:8009/#/userAuthorizationByUserId?serverIp=8.135.96.87&appid=wx226ffc0b68fa17e9";

		byte[] data = QrCodeUtil.getQrCodeByteArray(url);
		WxUtil.byteToImage(data, "d:/photo/fromByteArray.png");
	}
	...
	public void testUUID() {
		...
		for(int i = 0; i < 1; i++) {
			...
			uuid = "75fbbefd-a8b0-483f-a91a-4030c6d5a123";
			uuid = "85fbbefd-a8b0-483f-a91a-4030c6d5a123";
//            uuid = "0DF45AD1-8D4A-452E-91AA-73F0481B8908";
//			System.out.println("uuid:" + uuid);
			String uuidTail2 = uuid.substring(uuid.length() - encodeLength);
			uuidTail2 = uuidTail2.toUpperCase();
			String uuidHead2 = uuid.substring(0, encodeLength);
			uuidHead2 = uuidHead2.toUpperCase();
//			System.out.println("uuidTail2:" + uuidTail2);
//			System.out.println("uuidHead2:" + uuidHead2);
//			String uuidMerge = uuidHead2 + uuidTail2;
			String uuidMerge = uuidTail2;
			String sign = WxUtil.signEnCode(uuidMerge);
			System.out.println("sign:" + sign);
		}

//		String test = "-a-1f3r43r";
//		test = test.toUpperCase();
//		System.out.println(test);
//		sign = WxUtil.signEnCode(test);
//		System.out.println("sign:" + sign);
	}
...
//		Object objValue = InvokeSetGetUtil.getter(auditDelayCount, "dateTest");
	...
	public void testApplicationProperties() {
		System.out.println(WxOfficialAccountController.appid);
		System.out.println(WxOfficialAccountController.appsecret);
		System.out.println(WxOfficialAccountController.accessTokenTest);
	}
}
