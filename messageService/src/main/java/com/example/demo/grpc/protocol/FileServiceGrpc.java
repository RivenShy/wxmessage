...
public final class FileServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.demo.grpc.protocol.User,
      com.example.demo.grpc.protocol.FileOuterClass.File> getGetFileMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getFile",
      requestType = com.example.demo.grpc.protocol.User.class,
      responseType = com.example.demo.grpc.protocol.FileOuterClass.File.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.demo.grpc.protocol.User,
      com.example.demo.grpc.protocol.FileOuterClass.File> getGetFileMethod() {
    io.grpc.MethodDescriptor<com.example.demo.grpc.protocol.User, com.example.demo.grpc.protocol.FileOuterClass.File> getGetFileMethod;
      ...
      synchronized (FileServiceGrpc.class) {
        if ((getGetFileMethod = FileServiceGrpc.getGetFileMethod) == null) {
          FileServiceGrpc.getGetFileMethod = getGetFileMethod =
              io.grpc.MethodDescriptor.<com.example.demo.grpc.protocol.User, com.example.demo.grpc.protocol.FileOuterClass.File>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.demo.grpc.protocol.FileOuterClass.File.getDefaultInstance()))
  ...
  public static abstract class FileServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getFile(com.example.demo.grpc.protocol.User request,
        io.grpc.stub.StreamObserver<com.example.demo.grpc.protocol.FileOuterClass.File> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.example.demo.grpc.protocol.FileOuterClass.File>(
  ...
  public static final class FileServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FileServiceBlockingStub> {
    ...
    /**
     */
    public com.example.demo.grpc.protocol.FileOuterClass.File getFile(com.example.demo.grpc.protocol.User request) {
  ...
  public static final class FileServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FileServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.demo.grpc.protocol.FileOuterClass.File> getFile(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FILE:
          serviceImpl.getFile((com.example.demo.grpc.protocol.User) request,
              (io.grpc.stub.StreamObserver<com.example.demo.grpc.protocol.FileOuterClass.File>) responseObserver);
          break;
        default:
