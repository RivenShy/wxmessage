...
public class ChangeBindApplyController {
    ...
    public PageInfo<ChangeBindApply> list(@RequestParam(value = "start", defaultValue = "1") int start, @RequestParam(value = "size", defaultValue = "5") int size) throws Exception {
        PageHelper.startPage(start,size,"id desc");
        List<ChangeBindApply> hs = changeBindApplyService.list();
